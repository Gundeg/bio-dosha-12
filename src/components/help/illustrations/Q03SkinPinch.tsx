    ...
    >
      ...
      <g stroke="currentColor" strokeWidth={2.5} strokeLinecap="round" strokeLinejoin="round">
        ...
        <g className="q3-pinch q3-anim">
          ...
          <path d="M60 36 C54 48 49 64 47.5 76 C46.5 81 49 85 52.5 85 C56 85 58.5 81 57.5 76.5 C59 62 66 46 76 36" />
          ...
          <path d="M60 36 C63 27 69 22 78 21 C88 20 95 21 99 23 C106 25 109 30 105 35 C111 37 112 44 106 47 C111 50 110 57 103 58 C98 59 94 60 90 59 C83 65 76 71 70.5 76 C72 81 69.5 85 66 85 C62.5 85 60.5 81 62 76.5 C67 70 73 64 80 57" />
