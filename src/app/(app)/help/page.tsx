...
const STEPS = [
  {
    ...
    body: "12 энгийн асуултад нэг удаа хариулахад таны төрөлхийн биеийн төрөл (махбод) болон суурь тоо Kt тогтоогдоно. Асуулт бүрийн «Хэрхэн тодорхойлох вэ?» товч хариултаа бодитоор шалгах аргыг хөдөлгөөнт зургаар үзүүлнэ.",
  },
  {
    icon: "⚖️",
...
const FAQ = [
  {
    q: "Асуултад хэрхэн зөв хариулах вэ?",
    a: "Асуулт бүрийн доорх «Хэрхэн тодорхойлох вэ?» товчийг дарвал тухайн шинжийг бодитоор шалгах арга хөдөлгөөнт зургаар гарна. Жишээ нь ясны хэмжээг бугуйн сорилоор мэднэ: нэг гарынхаа бугуйг нөгөө гараараа атгаад — эрхий, долоовор хуруу давж гарвал жижиг, үзүүрүүд яг хүрвэл дундаж, хүрэхгүй бол том ястай. Зураг гурван үр дүнгээр ээлжлэн эргэлдэх ба хариулт дээр дарвал тухайн төлөвт царцана.",
  },
  {
